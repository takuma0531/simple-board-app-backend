...
class Config(object):
  ...
  SQLALCHEMY_DATABASE_URI = os.environ.get('CLEARDB_DATABASE_URL') or  'mysql+pymysql://b83f86ae979173:d7298307@us-cdbr-iron-east-01.cleardb.net/heroku_bd2f9e40800166b?reconnect=true'
